...
>>>>>>> 5f7ab96cdb4f60a1a7bb6936995946f68725ffbe
        ...
        <div id="page">
            ...
            <div id="fh5co-contact" class="fh5co-section animate-box">
                <div class="container">
                    ...
                    <div class="row">
                        <div>
                            <form action="servierReview.php" onsubmit="return valideUpload();" id="form-wrap" method="post" enctype="multipart/form-data">

                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label for="name">Food</label>
                                        <input name="foodname" type="text" class="form-control" id="name">
                                        <span class="error" id="foodname_error" style="color:red; text-decoration: underline;"></span>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12">
